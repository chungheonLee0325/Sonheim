...
> [View on GitHub](https://github.com/chungheonLee0325/Sonheim/blob/main/Sonheim/Source/Sonheim/AreaObject/Player/Utility/InteractionComponent.cpp#L338)
```cpp
...
*   **[[6.2 아이템 시스템|`ABaseItem`]]:** `Interact_Implementation`에서 즉시 아이템을 획득합니다.
*   **[[6.5 제작 시스템|`ACraftingStation`]]:** `Interact_Implementation`에서 제작대의 내부 상태에 따라 \'아이템 수령\', \'제작 돕기\', \'UI 열기\' 중 하나의 행동을 선택합니다.
*   **[[6.4 보관함 시스템|`ABaseContainer`]]:** `Interact_Implementation`에서 보관함 UI를 엽니다.
...
*   [[7.1 UI 아키텍처|7.1_UI_Architecture]]
