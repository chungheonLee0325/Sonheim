...
*   **장비 시스템**
    ...
    *   **스탯 실시간 연동:** 장비를 장착하거나 해제하는 즉시, [[4.3 스탯 시스템|캐릭터의 스탯]]이 실시간으로 변경됩니다.
...
1.  **데이터 영속성 (Data Persistence):** 플레이어가 죽거나 재접속하더라도 모든 아이템 정보가 안전하게 유지되어야 합니다. 이를 위해 컴포넌트는 폰(Pawn)이 아닌, 세션 내내 유지되는 [[2.4 플레이어 클래스 아키텍처|`PlayerState`]]에 소속됩니다.
