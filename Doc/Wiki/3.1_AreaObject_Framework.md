...
*   **통합 스킬 인터페이스**
    ...
    *   (상세: **[[3.3 스킬 아키텍처|3.3_Skill_Architecture]]**, **[[3.4 애니메이션 시스템|3.4_Animation_System]]**)
...
> [View on GitHub](https://github.com/chungheonLee0325/Sonheim/blob/main/Sonheim/Source/Sonheim/AreaObject/Base/AreaObject.cpp#L30)
```cpp
