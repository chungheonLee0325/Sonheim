...
> [!NOTE]
> 이 문서는 팰 시스템을 구성하는 **3개 컴포넌트의 역할과 책임(What & Why)**에 집중합니다. 이 컴포넌트들이 협력하여 팰을 포획하는 전체 데이터 흐름에 대한 더 자세한 분석은 **[[8.2 사례 연구: 팰 포획 시퀀스|8.2_Case_Study_Pal_Capture_Sequence]]** 문서에서 확인하실 수 있습니다.
